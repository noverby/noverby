...
def test_shell_mount_template_ref():
    ...
    var tmpl_id = w.call_i32("tmpl_builder_register", args_ptr_ptr(rt, builder))
    w.call_void("tmpl_builder_destroy", args_ptr(builder))

    # Create a TemplateRef VNode
    var vn = w.call_i32("vnode_push_template_ref", args_ptr_i32(store, tmpl_id))
...
def test_shell_diff_text_changed():
    ...
    var old_vn = w.call_i32("vnode_push_text", args_ptr_ptr(store, before_ptr))
    var buf = Int(w.call_i64("mutation_buf_alloc", args_i32(4096)))
    _ = w.call_i32(
        "shell_mount", args_ptr_ptr_i32_i32(shell, buf, 4096, old_vn)
    )
...
def test_shell_full_mount_update_cycle():
    ...
    var v0 = w.call_i32("vnode_push_template_ref", args_ptr_i32(store, tmpl_id))
    ...
    var v1 = w.call_i32("vnode_push_template_ref", args_ptr_i32(store, tmpl_id))
...
def test_shell_independent_instances():
    ...
    w.call_void("shell_write_signal_i32", args_ptr_i32_i32(shell_a, sig_a, 999))
    assert_equal(
