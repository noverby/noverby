...
fn test_neg_int32_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_neg_int32_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        Int(w[].call_i32("neg_int32", args_i32(-5))),
        5,
        "neg_int32(-5) === 5",
...
fn test_neg_int32_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_neg_int64_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_neg_int64_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        Int(w[].call_i64("neg_int64", args_i64(-42))),
        42,
        "neg_int64(-42) === 42",
...
fn test_neg_int64_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_neg_float64_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_neg_float64_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        w[].call_f64("neg_float64", args_f64(-3.14)),
        3.14,
        "neg_float64(-3.14) === 3.14",
...
fn test_neg_float64_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
...
fn test_abs_int32_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_abs_int32_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        Int(w[].call_i32("abs_int32", args_i32(-5))),
        5,
        "abs_int32(-5) === 5",
...
fn test_abs_int32_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_abs_int64_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_abs_int64_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        Int(w[].call_i64("abs_int64", args_i64(-99))),
        99,
        "abs_int64(-99) === 99",
...
fn test_abs_int64_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_abs_float32_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
...
fn test_abs_float32_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    var result = Float64(w[].call_f32("abs_float32", args_f32(-2.5)))
    var expected = Float64(Float32(2.5))
    assert_equal(result, expected, "abs_float32(-2.5)")
...
fn test_abs_float64_positive(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
...
fn test_abs_float64_negative(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
        w[].call_f64("abs_float64", args_f64(-3.14)),
        3.14,
        "abs_float64(-3.14) === 3.14",
...
fn test_abs_float64_zero(w: UnsafePointer[WasmInstance, MutExternalOrigin]) raises:
    assert_equal(
