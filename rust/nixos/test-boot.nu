...
#
# Usage:
#   nu test-boot.nu              # Run with defaults (rust-nixos, 15s timeout)
...
#   1 — boot failed (kernel panic, rust-systemd crash, or timeout)
...
def main [
    ...
    --config: string = "rust-nixos" # NixOS configuration name
